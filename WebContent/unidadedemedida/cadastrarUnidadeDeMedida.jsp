...
<fieldset>
	...
	<div class="col-lg-12">
		...
		<textarea rows="1" cols="1" class="form-control" placeholder="Informações Adicionais" name="descricao" id="descricao" maxlength="400"><%=(unidadedemedida.getDescricao() == null) ? "" : unidadedemedida.getDescricao()%></textarea>
		<br>
	</div>
