...
<fieldset>
	...
	<form name="frm" id="frm" method="post" action="./dispatcher">
		...
		<div id="legend">
			<legend><h2>Consultar <small>Usuário</small></h2></legend>
		</div>	
			
		<div class="col-lg-3">
			<input autofocus="autofocus" type="text" class="form-control" placeholder="Digite o usuário" name="nome" id="usuario" maxlength="38" value="<%=(usuarioFilter.getNome() != null) ? usuarioFilter.getNome() : ""%>">
		</div>
